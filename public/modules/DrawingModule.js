/**
 * DrawingModule - Handles all canvas drawing functionality for keyframes
 * Completely isolated from the main application logic
 */
export class DrawingModule {
  ...
  hasDrawing(filename) {
    return this.drawingHistory.has(filename);
  }

  getAllDrawings() {
    return new Map(this.drawingHistory);
  }
}
